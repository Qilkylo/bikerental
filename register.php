...
if(isset($_POST['regs']))
{
    ...
    $Pass=md5($pass);
    if(empty($name)|| empty($email)|| empty($stud_num)|| empty($phone_number)|| empty($pass) || empty($gender))
    {
        ...
        $sql="insert into users (NAME,EMAIL,STUD_NUM,PHONE_NUMBER,PASSWORD,GENDER) values('$name','$email','$stud_num',$phone_number,'$Pass','$gender')";
...
.invalid:before {
 ...
 <div class="main">
        ...
        <form id="register" action="register.php" method="POST">    
            ...
            id="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="ex: example@ex.com"placeholder="Enter Valid Email" required>
            <br><br>
            
            <label>Student Number : </label>
            <br>
            <input type="text" name="stud_num"
            id="stud_num" placeholder="Enter Your Student Number" required>
            <br><br>
